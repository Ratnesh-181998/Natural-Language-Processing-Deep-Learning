...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=240&text=NLP%20Deep%20Learning&fontSize=42&fontColor=ffffff&animation=fadeIn" />
</div>
...
# Deep Learning (DL) for Natural Language Processing ( NLP)

- L1 NLP: Intro to NLP
- L2 NLP: Text Representation
- L3 NLP: Word Embedding – Word2Vec
- L4 NLP: Language Modeling
- L5 NLP: Topic Modeling
- L6 NLP: RNN’s
- L7 NLP: LSTM
- L8 NLP: NER
- L9 NLP: Attention
- L10 NLP: Transformers
- L11 NLP: BERT
